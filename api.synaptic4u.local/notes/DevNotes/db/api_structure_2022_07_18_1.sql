...
) ENGINE=InnoDB AUTO_INCREMENT=1690 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2869 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mykeys` (
  ...
  KEY `datedon` (`datedon`),
  CONSTRAINT `mykeys_userid_fk` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1748958 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stream` (
  ...
  KEY `mykey` (`mykey`(768)),
  KEY `datedon` (`datedon`),
  KEY `stream_datedon_IDX` (`datedon`) USING BTREE,
  KEY `stream_nonce_IDX` (`nonce`(768)) USING BTREE,
  KEY `stream_mykey_IDX` (`mykey`(768)) USING BTREE,
  CONSTRAINT `stream_userid_fk` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1552531 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-07-18 10:55:39
