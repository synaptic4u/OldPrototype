<form class="needs-validation" method="POST" action="" id="UserInvite" novalidate>
    <input type="hidden" name="hierachyid" value="<?php echo $hierachyid; ?>" minLength="1" required />
    <input type="hidden" name="detid" value="<?php echo $detid; ?>" minLength="1" required />
    <input type="hidden" name="userid" value="<?php echo $userid; ?>" minLength="1" required />
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <h5 class="h5">Please update your details</h5>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <p>You have been invited by <?php echo $invitedby; ?> from <?php echo $org; ?><br>
                            You will be joining their organization and will have access to all the applications that you have been registered for.</p>
                        </div>
                    </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1  position-relative">
                                ...
                                <input minLength="2"
                                    class="w-100 p-2 form-control required <?php echo (is_null($firstname['value'])) ? '' : $firstname['message']; ?>"
                                    type="text" placeholder="First Name" aria-describedby="firstname" name="firstname"
                                    value="<?php echo (is_null($firstname['value'])) ? '' : $firstname['value'] ; ?>"
                                    required />
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                                ...
                                <input minLength="2"
                                    class="w-100 p-2 form-control required <?php echo (!is_null($surname['value'])) ? $surname['message'] : ''; ?>"
                                    type="text" placeholder="surname" aria-describedby="surname" name="surname"
                                    value="<?php echo (!is_null($surname['value'])) ? $surname['value'] : ''; ?>"
                                    required />
                                <div class="valid-feedback">
                                    Looks good.
                                </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                                ...
                                <input minLength="10"
                                    class="w-100 p-2 form-control required <?php echo (!is_null($contactnu['value'])) ? $contactnu['message'] : ''; ?>"
                                    type="text" placeholder="Contact Number" aria-describedby="contactnu"
                                    name="contactnu"
                                    value="<?php echo (!is_null($contactnu['value'])) ? $contactnu['value'] : ''; ?>"
                                    required />
                                <div class="valid-feedback">
                                    Looks good.
                                </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                                ...
                                <input minLength="10"
                                    class="w-100 p-2 form-control required <?php echo (!is_null($email['value'])) ? $email['message'] : ''; ?>"
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                                ...
                                <input minLength="15"
                                    class="w-100 p-2 form-control required <?php echo (!is_null($passkey['value'])) ? $passkey['message'] : ''; ?>"
                                    type="password" placeholder="Password" aria-describedby="passkey" name="passkey"
                                    value="<?php echo (!is_null($passkey['value'])) ? $passkey['value'] : ''; ?>"
                                    required />
                                <div class="valid-feedback">
                                    Looks good.
                                </div>
                        ...
                        <div class="col-sm-12 height:250px">
                            <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                                ...
                                <div style="height: 200px;" class="custom-control custom-switch overflow-auto"
                                    ...
                                    <input type="checkbox"
                                        class="custom-control-input required <?php echo (!is_null($popi_compliance['value'])) ? $popi_compliance['message'] : ''; ?>"
                    ...
                    <div class="row mt-2 mb-5">
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-sm btn-outline-primary" type="button" onclick="grab('init','<?php echo $inviteStore; ?>','<?php echo $user; ?>',
                                        this.form.id);">Save</button>
                        </div>
                    </div>
                </div>
            </div>
