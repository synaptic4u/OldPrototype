 <form method="POST" class="fading needs-validation text-wrap m-1 p-1" id="HierachyParticulars" novalidate>
    ...
    <div class="container m-0 p-0">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            <img loading="lazy" class="img-thumbnail rounded " width="62.22px" height="35px"
                                src="https://<?php echo $config['url']['server']; ?>/hierachy/default.webp"
                                alt="image of Synaptic4U ?>" id="hierachy-logo">
                            <?php } else { ?>
                        ...
                        <div class="col-sm-12 mt-2">
                            <input class="form-control" type="file" name="hierachy_profile_logo"
                                id="hierachy-profile-logo"
            ...
            <div class="col-sm-12">
                <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                    ...
                    <input minLength="2"
                        ...
                        value="<?php echo (!is_null($phone['pass'])) ? $phone['value'] : ''; ?>" />
                    <div class="valid-feedback">
                        Looks good.
                    </div>
                    <div class="invalid-feedback">
            ...
            <div class="col-sm-12">
                <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                    ...
                    <textarea minLength="20" rows="2"
                        ...
                        name="address"><?php echo (!is_null($address['pass'])) ? $address['value'] : ''; ?></textarea>
                    <div class="valid-feedback">
                        Looks good.
                    </div>
                    <div class="invalid-feedback">
                ...
                <fieldset class="border rounded ps-3 pe-3 pb-3 pt-0">
                    ...
                    <div class="form-check form-switch">
                        <input
                            ...
                            type="checkbox" id="hierachyispostal" name="hierachyispostal" href="#postal-address"
                            role="button" data-bs-toggle="collapse"
                            aria-expanded="<?php echo (!is_null($ispostal['pass'])) ? (((int) $ispostal['value'] === 1) ? 'false' : 'true') : 'true'; ?>"
                            aria-controls="postal-address"
                            <?php echo (!is_null($ispostal['pass'])) ? (((int) $ispostal['value'] === 1) ? ' checked' : '') : ''; ?>>
                        <label class="form-check-label" for="hierachyispostal" data-bs-toggle="tooltip"
                            data-bs-html="true"
                            title="If set to true, the organization's postal address will be set to the physical address.">Physical
                            & Postal Address the same?</label>
                    </div>
                    <div class="valid-feedback">
                        Looks good.
                    </div>
        ...
        <div class="row mt-2 <?php echo (!is_null($ispostal['pass'])) ? (((int) $ispostal['value'] === 1) ? 'collapse' : 'show') : 'show'; ?>"
            id="postal-address">
            <div class="col-sm-12">
                <fieldset class="border rounded ps-3 pe-3 pb-3 pt-1">
                    <legend class="w-auto float-none">
                    ...
                    <textarea minLength="20" rows="2"
                        ...
                        type="text" placeholder="Postal Address" aria-describedby="postal"
                        name="postal"><?php echo (!is_null($postal['pass'])) ? $postal['value'] : ''; ?></textarea>
                    <div class="valid-feedback">
                        Looks good.
                    </div>
                    <div class="invalid-feedback">
        ...
        <div class="row mt-2 mb-2">
            <div class="col-sm-12 text-center">
                <button class="btn btn-sm btn-outline-primary" type="button"
                    onclick="grab('<?php echo $particulars_for_body_id; ?>','<?php echo $store; ?>','<?php echo $particulars; ?>', this.form.id);">Save</button>
            </div>
        </div>
    </div>
</form>