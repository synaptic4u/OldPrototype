...
<?php // Start outer loop
    if ((int) $personnel_applications_count > 0) {
        // array_shift($personnel_applications);
        foreach ($personnel_applications as $key => $app) {
...
?>
    ...
    <li>
        <a class="nav-link px-3 sidebar-link ariatoggler" data-bs-toggle="collapse"
            href="#collapse<?php echo $app['name']; ?>" role="button" aria-expanded="false"
            aria-controls="collapse<?php echo $app['name']; ?>"
        ...
        <div class="collapse" id="collapse<?php echo $app['name']; ?>">
            <div>
...
<?php // Start of inner condition1
                if (($menu[$cnt]['moduleid'] == $menu[$cnt]['submoduleid'])) {
                    ...
                    <li>
                        <a class="nav-link px-3 sidebar-link ariatoggler" data-bs-toggle="collapse"
                            href="#collapse<?php echo $menu[$cnt]['title']; ?>" role="button"
                            aria-expanded="false"
                            aria-controls="collapse<?php echo $menu[$cnt]['title']; ?>"
                            onclick="manageState(this);showActive(this);">
                            <span class="me-2">
                                <i class="bi bi-app"></i>
                            </span>
                        ...
                        <div class="collapse" id="collapse<?php echo $menu[$cnt]['title']; ?>">
                            <div>
                                <ul class="navbar-nav ps-3">
