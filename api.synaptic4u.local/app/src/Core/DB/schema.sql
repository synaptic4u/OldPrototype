...
) ENGINE=InnoDB AUTO_INCREMENT=1707 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2898 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stream` (
  ...
  KEY `mykey` (`mykey`(768)),
  KEY `datedon` (`datedon`)
) ENGINE=InnoDB AUTO_INCREMENT=6282 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-27 21:01:58
-- MariaDB dump 10.19  Distrib 10.6.9-MariaDB, for debian-linux-gnu (x86_64)
--
...
) ENGINE=InnoDB AUTO_INCREMENT=429184 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `encrypt` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `encrypt`;

--
-- Dumping events for database 'encrypt'
--

--
-- Dumping routines for database 'encrypt'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2022-09-27 21:02:00
