...
CREATE TABLE `applications` (
  ...
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `description` text,
  `core_system` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`appid`),
  KEY `name` (`name`)
...
CREATE TABLE `hierachy` (
  `hierachyid` int NOT NULL AUTO_INCREMENT,
  `hierachysubid` int NOT NULL,
  `userid` int NOT NULL,
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `hierachy_module_users` (
  ...
  `moduleid` int NOT NULL,
  `maintainedby` int NOT NULL,
  `include_exclude` int NOT NULL DEFAULT '0',
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `hierachy_particulars` (
  ...
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ispostal` int NOT NULL DEFAULT '0',
...
CREATE TABLE `hierachy_roles` (
  ...
  `hierachyid` int DEFAULT NULL,
  `maintainedby` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `exclude` int DEFAULT '0',
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `dependants` int NOT NULL DEFAULT '0',
...
CREATE TABLE `hierachy_type` (
  `hierachytypeid` int NOT NULL AUTO_INCREMENT,
  `userid` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `hierachyid` int DEFAULT '0',
  `exclude` int DEFAULT '0',
...
CREATE TABLE `hierachy_users` (
  `hierachyid` int NOT NULL,
  `userid` int NOT NULL,
  `maintainedby` int DEFAULT NULL,
  `roleid` int DEFAULT '7',
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `stream` (
  ...
  KEY `mykey` (`mykey`(768)),
  KEY `datedon` (`datedon`)
) ENGINE=InnoDB AUTO_INCREMENT=9081 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `passkey` blob,
  `popi_compliance` int NOT NULL DEFAULT '0',
  `active` int NOT NULL DEFAULT '1',
  `system_core` int NOT NULL DEFAULT '0',
  `createdon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `users_forgot_password` (
  `forgotid` int NOT NULL AUTO_INCREMENT,
  `userid` int NOT NULL,
  `datedon` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2024-08-19 20:23:47
